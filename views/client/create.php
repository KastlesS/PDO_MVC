    ...
    <div id="contenido">
        <form action="index.php?tabla=client&accion=guardar&evento=crear" method="POST">
            <div class="form-group">
                ...
                <input type="text" required class="form-control" id="fiscal" name="fiscal" aria-describedby="fiscal" placeholder="Introduce su ID Fiscal">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" name="name" placeholder="Introduce tu Nombre de Contacto">
            </div>
            <div class="form-group">
                <label for="tel">Número de Teléfono</label>
                <input type="text" required class="form-control" id="tel" name="tel" placeholder="Teléfono">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" required class="form-control" id="comp" name="comp" placeholder="Nombre de la Compañía">
            </div>
            <div class="form-group">
                <label for="comp">Número de la compañía</label>
                <input type="text" required class="form-control" id="compTel" name="compTel" placeholder="Número de la Compañía">
            </div>
            <div class="form-group">
