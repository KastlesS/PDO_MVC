...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div id="contenido">
        <div class="card" style="width: 18rem;">
            <div>
                <h5 class="card-title">ID: <?=$user->id ?> <br>NOMBRE: <?= $user->contact_name ?></h5>
                <p class="card-text">
                ID Fiscal: <?= $user->idFiscal ?> <br>
                Email: <?= $user->contact_email ?><br>
                Teléfono: <?= $user->contact_phone_number ?><br>
                Compañía: <?= $user->company_name ?><br>
                Dirección Compañía: <?= $user->company_address ?><br>
                Teléfono Compañía: <?= $user->company_phone_number ?><br>
                </p>
