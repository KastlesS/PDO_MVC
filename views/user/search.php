...
<input type="text" required class="form-control" id="busqueda" name="busqueda" value="<?=
$usuario ?>" placeholder="Buscar por Usuario">
</div>
...
<td><?= $user["name"] ?></td>
<td><?= $user["email"] ?></td>
<td><a class="btn btn-danger" href="index.php?tabla=user&accion=borrar&id=<?= $id
?>"><i class="fa fa-trash"></i> Borrar</a></td>
<td><a class="btn btn-success" href="index.php?tabla=user&accion=editar&id=<?= $id
